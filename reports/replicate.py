...
def main():
    ...
    tickets_list = get_tickets_for_update(fbcon, fbcursor)
    for number, co8_date in tickets_list:
        pgcursor.execute("update reports_ticket set co8_date=%s where ticket='%s';" , (co8_date, number))
    pgcon.commit()
